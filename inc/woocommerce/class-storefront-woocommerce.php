...
if ( ! class_exists( 'Storefront_WooCommerce' ) ) :
	...
	class Storefront_WooCommerce {
		...
		public function change_breadcrumb_delimiter( $defaults ) {
			...
			$defaults['wrap_before'] = '<div class="storefront-breadcrumb"><div class="col-full"><nav class="woocommerce-breadcrumb" aria-label="' . esc_attr__( 'breadcrumbs', 'storefront lumione' ) . '">';
