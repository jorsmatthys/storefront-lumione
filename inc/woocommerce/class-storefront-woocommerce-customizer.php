	...
	class Storefront_WooCommerce_Customizer extends Storefront_Customizer {
		...
		public function customize_register( $wp_customize ) {
			...
			$wp_customize->add_section(
				...
				array(
					'title'    => __( 'Product Page', 'storefront lumione' ),
					'priority' => 10,
					'panel'    => 'woocommerce',
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'       => __( 'Sticky Add-To-Cart', 'storefront lumione' ),
					'description' => __( 'A small content bar at the top of the browser window which includes relevant product information and an add-to-cart button. It slides into view once the standard add-to-cart button has scrolled out of view.', 'storefront lumione' ),
					'priority'    => 10,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					'type'        => 'checkbox',
					'section'     => 'storefront_single_product_page',
					'label'       => __( 'Product Pagination', 'storefront lumione' ),
					'description' => __( 'Displays next and previous links on product pages. A product thumbnail is displayed with the title revealed on hover.', 'storefront lumione' ),
					'priority'    => 20,
				)
			);
		}
