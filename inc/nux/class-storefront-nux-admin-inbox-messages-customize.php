...
if ( ! class_exists( 'Storefront_NUX_Admin_Inbox_Messages_Customize' ) ) :
	...
	class Storefront_NUX_Admin_Inbox_Messages_Customize {
		...
		public static function get_note() {
			$note = new Note();
			$note->set_title( __( 'Design your store with Storefront 🎨', 'storefront lumione' ) );
			$note->set_content( __( 'Visit the Storefront settings page to start setup and customization of your shop.', 'storefront lumione' ) );
			...
			$note->add_action(
				...
				__( 'Let\'s go!', 'storefront lumione' ),
