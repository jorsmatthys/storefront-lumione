...
if ( ! class_exists( 'Storefront_Customizer' ) ) :
	...
	class Storefront_Customizer {
		...
		public function customize_register( $wp_customize ) {
			...
			$wp_customize->get_section( 'background_image' )->title    = __( 'Background', 'storefront lumione' );
			$wp_customize->get_section( 'background_image' )->priority = 30;

			// Change header image section title & priority.
			$wp_customize->get_section( 'header_image' )->title    = __( 'Header', 'storefront lumione' );
			...
			$wp_customize->add_section(
				...
				array(
					'title'    => __( 'Typography', 'storefront lumione' ),
					'priority' => 45,
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'storefront_heading_color',
					array(
						'label'    => __( 'Heading color', 'storefront lumione' ),
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'storefront_text_color',
					array(
						'label'    => __( 'Text color', 'storefront lumione' ),
						'section'  => 'storefront_typography',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'storefront_accent_color',
					array(
						'label'    => __( 'Link / accent color', 'storefront lumione' ),
						'section'  => 'storefront_typography',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'storefront_hero_heading_color',
					array(
						'label'    => __( 'Hero heading color', 'storefront lumione' ),
						'section'  => 'storefront_typography',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'storefront_hero_text_color',
					array(
						'label'    => __( 'Hero text color', 'storefront lumione' ),
						'section'  => 'storefront_typography',
			...
			$wp_customize->add_control(
				new Arbitrary_Storefront_Control(
					...
					array(
						...
						'type'     => 'heading',
						'label'    => __( 'Header background image', 'storefront lumione' ),
						'priority' => 6,
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'storefront_header_background_color',
					array(
						'label'    => __( 'Background color', 'storefront lumione' ),
						'section'  => 'header_image',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'storefront_header_link_color',
					array(
						'label'    => __( 'Link color', 'storefront lumione' ),
						'section'  => 'header_image',
			...
			$wp_customize->add_section(
				'storefront_footer',
				array(
					'title'       => __( 'Footer', 'storefront lumione' ),
					'priority'    => 28,
					'description' => __( 'Customize the look & feel of your website footer.', 'storefront lumione' ),
				)
			);
			...
			$wp_customize->add_section(
				'storefront_buttons',
				array(
					'title'       => __( 'Buttons', 'storefront lumione' ),
					'priority'    => 45,
					'description' => __( 'Customize the look & feel of your website buttons.', 'storefront lumione' ),
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'storefront_button_alt_background_color',
					array(
						'label'    => __( 'Alternate button background color', 'storefront lumione' ),
						'section'  => 'storefront_buttons',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'storefront_button_alt_text_color',
					array(
						'label'    => __( 'Alternate button text color', 'storefront lumione' ),
						'section'  => 'storefront_buttons',
			...
			$wp_customize->add_section(
				'storefront_layout',
				array(
					'title'    => __( 'Layout', 'storefront lumione' ),
					'priority' => 50,
				)
			);
			...
			$wp_customize->add_control(
				new Storefront_Custom_Radio_Image_Control(
					...
					array(
						...
						'label'    => __( 'General Layout', 'storefront lumione' ),
						'priority' => 1,
						'choices'  => array(
			...
			if ( apply_filters( 'storefront_customizer_more', true ) ) {
				$wp_customize->add_section(
					'storefront_more',
					array(
						'title'    => __( 'More', 'storefront lumione' ),
						'priority' => 999,
					)
				);
				...
				$wp_customize->add_control(
					new More_Storefront_Control(
						...
						'storefront_more',
						array(
							'label'    => __( 'Looking for more options?', 'storefront lumione' ),
